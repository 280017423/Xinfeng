package com.zjhbkj.xinfen.widget;
...
public class CustomDialog extends Dialog {
	...
	public static class Builder {
		...
		public CustomDialog create(int id) {
			...
			View titleLine = layout.findViewById(R.id.view_title_line);
			...
			setDialogTitle(tvTitle, titleLine);
		 ...
		 *            对话框标题对象
		 */
		private void setDialogTitle(TextView tvTitle, View titleLine) {
