...
public class NetworkState implements INetworkState {
	...
	public boolean isNetworkAvailable() {
		Context context = XinfengApplication.CONTEXT;
		if (context == null) {
			return false;
		}
	...
	public boolean isGPSAvailable() {
		boolean result;
		LocationManager locationManager = (LocationManager) XinfengApplication.CONTEXT
	...
	public boolean isWifiAvailable() {
		WifiManager wm = (WifiManager) XinfengApplication.CONTEXT.getSystemService(Context.WIFI_SERVICE);
	...
	public String getConnectionWifiSSID() {
		String ssid = "";
		WifiManager wifiManager = (WifiManager) XinfengApplication.CONTEXT.getSystemService(Context.WIFI_SERVICE);
