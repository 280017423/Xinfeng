...
class EntitiesMap {
	...
	private Map<String, WeakReference<BaseModel>> mTypeModelMap = new HashMap<String, WeakReference<BaseModel>>();
	...
	void set(BaseModel e) {
		...
		mTypeModelMap.put(key, new WeakReference<BaseModel>(e));
	}
